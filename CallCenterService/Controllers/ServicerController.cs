...
namespace CallCenterService.Controllers
{
    public class ServicerController : Controller
    {
        ...
        public ServicerController(DatabaseContext context)
        {
            _context = context;    
        }
        ...
        public async Task<IActionResult> ServicerFaults()
        {
            //  return View("ServicerFaults");
            return View(await _context.ServicerFault.ToListAsync());
        }
    }
}
