...
namespace CallCenterService.Migrations
{
    ...
    [Migration("20180607205515_CalendarMigration6")]
    partial class CalendarMigration6
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("CallCenterService.Models.CalendarEvent", b =>
                {
                    b.HasOne("CallCenterService.Models.Repair")
                        .WithOne("CalendarEvent")
                        .HasForeignKey("CallCenterService.Models.CalendarEvent", "RepairId")
